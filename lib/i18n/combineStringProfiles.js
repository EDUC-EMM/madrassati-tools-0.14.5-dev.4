/**
 * Once the strings in Madrassati have been profiled via `yarn makemessages`
 ...
 * node combineStringProfiles.js ./madrassati/locale/en/LC_MESSAGES/csv_profiles
 */
...
const logging = logger.getLogger('Madrassati String Profiler');

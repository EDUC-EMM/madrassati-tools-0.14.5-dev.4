...
def _get_common_strings():
    """
    Text useful for all languages: displaying the language switcher, Madrassati version
...
def command_gen_subset_fonts():
    ...
    needs to download on first request, but reduces Madrassati's distribution size by a
    couple megabytes.
    """

  ...
  let bundle = {
    ...
    resolve: {
      ...
      modules: [
        ...
        // access madrassati-tools/node_modules modules during bundling.
        base_dir,
    ...
    resolveLoader: {
      modules: [
        ...
        // access madrassati-tools/node_modules loaders during bundling.
        base_dir,
        path.join(base_dir, 'node_modules'),
      ],
    },
    plugins: [
      ...
      // they are given in madrassati_plugins.py inside their relevant module.
      // Also define the current plugin version (for madrassati plugins bundled with madrassati, this is
      // the madrassati version).
      // Also add the copyright year for auto updated copyright footers.
      new webpack.DefinePlugin({
        __madrassatiModuleName: JSON.stringify(data.name),
